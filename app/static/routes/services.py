...
from app.utils.permissions import subscription_required, check_service_limit, is_test_plan_user, check_service_eligibility
...
def request_service(service_id):
    ...
    service = MarinaService.query.get_or_404(service_id)
    if request.method == 'POST':
        is_eligible, message = check_service_eligibility()
        if not is_eligible:
